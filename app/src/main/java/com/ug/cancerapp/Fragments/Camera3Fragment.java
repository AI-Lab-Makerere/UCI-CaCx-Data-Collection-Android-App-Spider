...
public class Camera3Fragment extends Fragment {
    ...
    public static final String FLON3 = "negative3";
    public static final String FLOP3 = "positive3";
    public static final String VR3 = "viaR3";
...
//                runTensorflowModel(bitmap);
    ...
    private void saveData(){
        ...
        editor.putString(IMAGE3, sImage);
        editor.putString(VR3, viar);
        editor.putString(FLON3, negative);
        editor.putString(FLOP3, positive);
...
//        Toast.makeText(getActivity(), "Data saved", Toast.LENGTH_SHORT).show();
    ...
    public void loadData(){
        ...
        viar = sharedPreferences.getString(VR3, "");
        negative = sharedPreferences.getString(FLON3, "");
        positive = sharedPreferences.getString(FLOP3, "");
