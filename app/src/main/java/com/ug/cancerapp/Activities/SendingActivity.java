        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (checkedCount > 0){
                    ...
                    Toast.makeText(SendingActivity.this, " " + commaseparatedlist, Toast.LENGTH_SHORT).show();
...
//
//                }else {
//                    Toast.makeText(SendingActivity.this, "Nothing to submit", Toast.LENGTH_SHORT).show();
//                }
            }
        });
